...
const Faqs = () => {
  ...
  return (
    <div id='faqs' className='mt-40 mx-3 sm:mx-6 lg:mx-0 relative overflow-hidden'>
      {/* Gradient */}
      
      <div className='max-w-[62.3125rem] pb-9 mx-auto bg-[#f7f9ff]/[2%] rounded-[10px]'>
        <h2 className='font-firaCode font-extrabold text-[#F9D423] text-[2.125rem] pt-4 pb-6 text-center'>
          FAQs
        </h2>
          ...
          >
            <div className='flex justify-between'>
              ...
              <div className='pr-4 sm:pr-10 md:pr-16 flex justify-center items-center'>
                <img
                  className='transition-transform duration-500 object-contain h-[30px] w-[30px] md:h-[45px] md:w-[45px]'
